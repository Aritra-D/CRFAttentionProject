...
%     plot(hPlot,energyData.freqVals,mean(log10(attDataBL_psd),1,nanFlag),'k','LineWidth',lineWidth);
    plot(hPlot,energyData.freqVals,mean(log10(ignDataBL_psd),1,nanFlag),'-g','LineWidth',lineWidth);
    
    yyaxis right
    plot(hPlot,energyData.freqVals,mean(deltaPSD,1,nanFlag),'color',[0.4940 0.1840 0.5560],'LineWidth',lineWidth);
end
...
linkaxes(hPlot2(2));  xlim(hPlot2(2),[0 4]); ylim(hPlot2(2),[-0.5 0.5])
