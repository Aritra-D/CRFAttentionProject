...
if strcmp(protocolType, 'SFOri-Mapping')
    protocolList{1} = 99;   maxGamma_SFIndex{1} = 2;  maxGamma_OriIndex{1} = 4;  % Niloy NM
    protocolList{2} = 111;  maxGamma_SFIndex{2} = 2;  maxGamma_OriIndex{2} = 2;  % Svee  SP
    protocolList{3} = 125;  maxGamma_SFIndex{3} = 1;  maxGamma_OriIndex{3} = 4;  % Liza  LK
    protocolList{4} = 139;  maxGamma_SFIndex{4} = 1;  maxGamma_OriIndex{4} = 4;  % Srishty SA
    protocolList{5} = 151;  maxGamma_SFIndex{5} = 2;  maxGamma_OriIndex{5} = 3;  % Sunreeta SB
    protocolList{6} = 165;  maxGamma_SFIndex{6} = 1;  maxGamma_OriIndex{6} = 2;  % Surya    SSP
    protocolList{7} = 179;  maxGamma_SFIndex{7} = 1;  maxGamma_OriIndex{7} = 2;  % Saurabh  SK
    protocolList{8} = 193;  maxGamma_SFIndex{8} = 1;  maxGamma_OriIndex{8} = 4;  % Divya   DG
    protocolList{9} = 207;  maxGamma_SFIndex{9} = 2;  maxGamma_OriIndex{9} = 3;  % Nilanjana NN
    protocolList{10} = 221; maxGamma_SFIndex{10} = 2; maxGamma_OriIndex{10} = 4; % Aritra AD
    protocolList{11} = 235; maxGamma_SFIndex{11} = 1; maxGamma_OriIndex{11} = 2; % Ankan  AB
end
